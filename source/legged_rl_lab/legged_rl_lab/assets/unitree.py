...
UNITREE_A1_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        asset_path=f"{LEGGED_RL_LAB_ROOT_DIR}/assets/robots/unitree/a1_description/urdf/a1.urdf",
...
UNITREE_GO2_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        merge_fixed_joints=True,
        replace_cylinders_with_capsules=False,
        asset_path=f"{LEGGED_RL_LAB_ROOT_DIR}/assets/Robots/unitree/go2_description/urdf/go2_description.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
UNITREE_GO2W_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        merge_fixed_joints=True,
        replace_cylinders_with_capsules=False,
        asset_path=f"{LEGGED_RL_LAB_ROOT_DIR}/assets/Robots/unitree/go2w_description/urdf/go2w_description.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
UNITREE_B2_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        merge_fixed_joints=True,
        replace_cylinders_with_capsules=False,
        asset_path=f"{LEGGED_RL_LAB_ROOT_DIR}/assets/Robots/unitree/b2_description/urdf/b2_description.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
UNITREE_B2W_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        merge_fixed_joints=True,
        replace_cylinders_with_capsules=False,
        asset_path=f"{LEGGED_RL_LAB_ROOT_DIR}/assets/Robots/unitree/b2w_description/urdf/b2w_description.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
UNITREE_G1_29DOF_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        asset_path=f"{LEGGED_RL_LAB_ROOT_DIR}/assets/Robots/unitree/g1_description/urdf/g1_29dof_rev_1_0.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
